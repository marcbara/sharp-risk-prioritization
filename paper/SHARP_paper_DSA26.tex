...
Bara~Iniesta, M.: Augmenting human decision-making in risk management: An {LLM}-based framework for enhancing project risk register quality. Working paper (2025). Reference implementation: \url{https://github.com/marcbara/risk-register-llm}
